     ...
     return (
        ...
        <div className="Process">
          ...
          <div className="process">
            ...
            <p>for specific weeks showcasing progress in consecutive weeks.</p>
            <p> This helps me stay on task and know how to prioritize.</p>
            <p>These notes also go into my README.</p><br></br>
